...
class MediaLoader(private val activity: FragmentActivity, type: Int, private val isGif: Boolean,
    ...
    private var type = com.hongyue.app.muse.PhoenixConstant.TYPE_IMAGE
    ...
    fun loadAllMedia(localMediaLoadListener: LocalMediaLoadListener) {

        LoaderManager.getInstance(activity).initLoader(type, null, // type -> id
            object : LoaderManager.LoaderCallbacks<Cursor> {
                ...
                override fun onCreateLoader(id: Int, args: Bundle?): Loader<Cursor> {
                    ...
                    return when (id) {
                        com.hongyue.app.muse.PhoenixConstant.TYPE_ALL ->
                            CursorLoader(
                                    activity,
                                    ALL_QUERY_URI,
                                    ALL_PROJECTION,
                        ...
                        com.hongyue.app.muse.PhoenixConstant.TYPE_IMAGE -> CursorLoader(
                                activity,
                                ...
                                MediaStore.Files.FileColumns.DATE_ADDED + " DESC")
                        com.hongyue.app.muse.PhoenixConstant.TYPE_VIDEO -> CursorLoader(
                                activity,
                        ...
                        com.hongyue.app.muse.PhoenixConstant.TYPE_AUDIO -> CursorLoader(
                                activity,
...
//                            val allImageFolder = MediaFolder()
                        val allImageFolder =
                            MediaFolder("", "", "", 0, 0, true, ArrayList())
                        ...
                        if (count > 0) {
                            ...
                            do {
                                ...
                                if (mimeType.startsWith(com.hongyue.app.muse.PhoenixConstant.AUDIO)) {
                                    fileType = MimeType.ofAudio()
                                } else if (mimeType.startsWith(com.hongyue.app.muse.PhoenixConstant.IMAGE)) {
                                    fileType = MimeType.ofImage()
                                } else if (mimeType.startsWith(com.hongyue.app.muse.PhoenixConstant.VIDEO)) {
                            ...
                            localMediaLoadListener.loadComplete(imageFolders)
                        } else {
                            // 如果没有相册
                            localMediaLoadListener.loadComplete(imageFolders)
                        }
