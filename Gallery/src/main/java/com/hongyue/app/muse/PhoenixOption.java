...
public class PhoenixOption implements Parcelable {
    ...
    public PhoenixOption ebleRecord(boolean recordEnable) {
        isRecordEnable = recordEnable;
        return this;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(this.isRecordEnable ? (byte) 1 : (byte) 0);
    }
    ...
    protected PhoenixOption(Parcel in) {
        ...
        this.isRecordEnable = in.readByte() != 0;
    }
